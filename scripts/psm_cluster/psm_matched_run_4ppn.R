...
print(jobid)
args <- read.table("/scratch/edbeck/psm/psm_matched_args.txt", header = F, stringsAsFactors = F)[jobid,]
print(args)
...
brms_matched_fun <- function(trait, outcome, mod, chain){
...
brms_matched_fun(args[,1], args[,2], args[,3], args[,4])